...
public class GuiSettingsView extends JFrame {
    ...
    private void initFrame() {
        ...
        garg.setBorder(new TitledBorder(new LineBorder(textArroundColor, 1, true), "---", TitledBorder.CENTER, TitledBorder.BELOW_TOP, new Font("Arial", Font.BOLD, 14), textArroundColor));
        devBy.add(garg);
        ...
        legr.setBorder(new TitledBorder(new LineBorder(textArroundColor, 1, true), "---", TitledBorder.CENTER, TitledBorder.BELOW_TOP, new Font("Arial", Font.BOLD, 14), textArroundColor));
        devBy.add(legr);
        legr.setLayout(new BoxLayout(legr, BoxLayout.Y_AXIS));

        JLabel lblInfoInfojap = new JLabel("---");
        ...
        JLabel lblNetudiant_1 = new JLabel("N-Etudiant: ---");
